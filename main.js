...
// // //     questionCountElement.innerText = `Question ${currentQuestionNumber} of ${totalQuestions}`;

// // //     // Append both the scoreDisplay and question count element to the container
// // //     container.innerHTML = "";
// // //     container.appendChild(scoreDisplay);
// // //     container.appendChild(questionCountElement);
// // // }
// // function endGame() {
// //     clearInterval(printer);
...
// //     const totalQuestions = questions.length;
// //     const currentQuestionNumber = currentQuestionIndex + 1;
// //     container.innerHTML = `<p>Question ${currentQuestionNumber} of ${totalQuestions}</p>`;
// // }
...
//     // Update status for each answer button
//     Array.from(answerButtonsElement.children).forEach(button => {
//         setStatusClass(button, button.dataset.correct);
//     });
...
nextButton.addEventListener("click", () => {
    currentQuestionIndex++;
    setNextQuestion();
    updateQuestionCount(); // Added this line
});
...
// const Qcount = document.querySelector("#container");
const containerAni = document.querySelector(".containerAni");
const box = document.querySelector(".box");
const clock = document.querySelector(".clock");
// const btnHi = document.querySelector("#highScore-btn");
...
function updateQuestionCount() {
    ...
    document.getElementById("question-count").innerText = `Question ${currentQuestionNumber} of ${totalQuestions}`;
}
...
const questions = [
    ...
    },
    {
        ...
        {
          "question": "If a square has an area of 16 square units, what is the length of each side?",
          "answers": [
            { "text": "3 units", "correct": false },
            { "text": "4 units", "correct": true },
            { "text": "5 units", "correct": false },
    ...
    },
    {
      ...
      },
      {
        ...
        "answers": [
          ...
          { "text": "To handle multiple conditions in an 'if-else' statement", "correct": true },
      ...
      {
        "question": "What will be the output of the code: `print(2 ** 3)`?",
        "answers": [
          { "text": "8", "correct": true },
          { "text": "6", "correct": false },
          { "text": "9", "correct": false },
      ...
      },
      {
        ...
        "answers": [
          ...
          { "text": "To create a zip archive", "correct": false },
          { "text": "To combine two or more iterables into tuples", "correct": true },
      ...
      },
      {
        ...
        "answers": [
          ...
          { "text": "To skip a loop iteration or function body", "correct": true },
          { "text": "To print a message to the console", "correct": false },
          { "text": "To create a password", "correct": false }
        ]
      },
      {
        "question": "What is the output of the code: `print(len('python'))`?",
        "answers": [
          { "text": "6", "correct": true },
          { "text": "7", "correct": false },
          { "text": "5", "correct": false },
      ...
      },
      {
        ...
        "answers": [
          ...
          { "text": "Addition and assignment", "correct": true }
        ]
      },
      {
